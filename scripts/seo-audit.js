...
function expectedCanonical(file) {
  const slugOverrides = {
    ...
    'how-it-works.html': `${siteOrigin}/how-it-works`,
    'practice.html': `${siteOrigin}/practice`,
    'premium.html': `${siteOrigin}/premium`,
    ...
    '02_practice.html': `${siteOrigin}/02_practice`,
    '03_practice.html': `${siteOrigin}/03_practice`,
    '04_practice.html': `${siteOrigin}/04_practice`,
    '05_practice.html': `${siteOrigin}/05_practice`,
    '06_practice.html': `${siteOrigin}/06_practice`,
    '07_practice.html': `${siteOrigin}/07_practice`,
    '08_practice.html': `${siteOrigin}/08_practice`,
    '09_practice.html': `${siteOrigin}/09_practice`,
    '10_practice.html': `${siteOrigin}/10_practice`,
    '11_practice.html': `${siteOrigin}/11_practice`,
    '12_practice.html': `${siteOrigin}/12_practice`,
    '13_practice.html': `${siteOrigin}/13_practice`,
    '14_practice.html': `${siteOrigin}/14_practice`,
    '15_practice.html': `${siteOrigin}/15_practice`,
  };
  return slugOverrides[file] || (file === 'index.html' ? `${siteOrigin}/` : `${siteOrigin}/${file.replace(/\\.html$/i, '')}`);
}
