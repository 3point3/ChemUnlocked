...
export const ALL_PROBLEMS = [
  ...
  {id:'p01', type:'calc', tag:'K Expression', q:'Write the equilibrium constant expression K for: 2NO(g) + O₂(g) ⇌ 2NO₂(g). Which answer is correct?',
    ...
    correct:1,
    solution:'<p>Write products over reactants, and raise each concentration to its coefficient.</p><p>K = <span class="chem-frac"><span class="chem-frac-n">[NO₂]²</span><span class="chem-frac-bar">/</span><span class="chem-frac-d">([NO]²[O₂])</span></span></p>'},
  ...
  {id:'p02', type:'calc', tag:'K Expression', q:'Which is the correct K expression for: N₂(g) + 3H₂(g) ⇌ 2NH₃(g)?',
    ...
    correct:0,
    solution:'<p>K = <span class="chem-frac"><span class="chem-frac-n">[NH₃]²</span><span class="chem-frac-bar">/</span><span class="chem-frac-d">([N₂][H₂]³)</span></span><br>Coefficients become exponents; products in numerator, reactants in denominator.</p>'},
  ...
  {id:'p03', type:'calc', tag:'K Expression', q:'For the reaction CaCO₃(s) ⇌ CaO(s) + CO₂(g), which K expression is correct?',
    ...
    correct:1,
    solution:'<p>Pure solids are omitted from the K expression, so both CaCO₃(s) and CaO(s) are left out.</p><p><strong>K = [CO₂]</strong></p>'},
  ...
  {id:'p04', type:'calc', tag:'K Expression', q:'For C(s) + O₂(g) ⇌ CO₂(g), which K expression is correct?',
    ...
    correct:2,
    solution:'<p>C(s) is a pure solid — it is omitted from K.<br><strong>K = <span class="chem-frac"><span class="chem-frac-n">[CO₂]</span><span class="chem-frac-bar">/</span><span class="chem-frac-d">[O₂]</span></span></strong></p>'},
  ...
  {id:'p08', type:'calc', tag:'Calculating K', q:'For 2SO₂(g) + O₂(g) ⇌ 2SO₃(g), at equilibrium: [SO₂] = 0.0560 M, [O₂] = 0.0280 M, [SO₃] = 0.0360 M. Find K.', answer:14.76, unit:'', tolerance:0.3,
    solution:'<p>K = <span class="chem-frac"><span class="chem-frac-n">[SO₃]²</span><span class="chem-frac-bar">/</span><span class="chem-frac-d">([SO₂]²[O₂])</span></span><br>K = <span class="chem-frac"><span class="chem-frac-n">(0.0360)²</span><span class="chem-frac-bar">/</span><span class="chem-frac-d">((0.0560)² × 0.0280)</span></span><br>K = <span class="chem-frac"><span class="chem-frac-n">0.001296</span><span class="chem-frac-bar">/</span><span class="chem-frac-d">(0.003136 × 0.0280)</span></span><br>K = <span class="chem-frac"><span class="chem-frac-n">0.001296</span><span class="chem-frac-bar">/</span><span class="chem-frac-d">0.00008781</span></span> = <strong>14.76</strong></p>'},
  ...
  {id:'p11', type:'calc', tag:'ICE Table', q:'H₂(g) + I₂(g) ⇌ 2HI(g), K = 49.0 at 450°C. Start: [H₂]₀ = [I₂]₀ = 0.500 M, [HI]₀ = 0. What is [HI] at equilibrium?', answer:0.778, unit:'M', tolerance:0.01,
    solution:'<p>From the ICE table, H₂ and I₂ each lose x and HI gains 2x.</p><p>K = <span class="chem-frac"><span class="chem-frac-n">(2x)²</span><span class="chem-frac-bar">/</span><span class="chem-frac-d">(0.500−x)²</span></span> = 49.0, so <span class="chem-frac"><span class="chem-frac-n">2x</span><span class="chem-frac-bar">/</span><span class="chem-frac-d">(0.500−x)</span></span> = 7.00.</p><p>Solve: 2x = 3.50 − 7.00x → 9.00x = 3.50 → x = 0.389 M.</p><p>[HI] = 2x = <strong>0.778 M</strong></p>'},
  ...
  {id:'p25', type:'calc', tag:'Calculating K', q:'For A(g) ⇌ 2B(g), starting with [A]₀ = 1.00 M and [B]₀ = 0, at equilibrium [B] = 0.620 M. Calculate K.', answer:0.557, unit:'', tolerance:0.01,
  ...
  {id:'p38', type:'calc', tag:'Calculating K', q:'For PCl₅(g) ⇌ PCl₃(g) + Cl₂(g), K = 0.040 at 300°C. Starting with [PCl₅]₀ = 0.800 M, find [PCl₅] at equilibrium.', answer:0.640, unit:'M', tolerance:0.02,
    solution:'<p>ICE: PCl₅ loses x; PCl₃ and Cl₂ gain x.<br>K = x²/(0.800−x) = 0.040<br>x² = 0.040(0.800−x) = 0.032−0.040x<br>x² + 0.040x − 0.032 = 0<br>x = [−0.040 + √(0.0016 + 0.128)]/2 = [−0.040 + 0.360]/2 = 0.160<br>[PCl₅] = 0.800 − 0.160 = <strong>0.640 M</strong></p>'},

  {id:'p39', type:'calc', tag:'Calculating K', q:'For 2NO(g) + Cl₂(g) ⇌ 2NOCl(g), K = 4.60 × 10⁴ at 25°C. At equilibrium [NO] = 0.0300 M and [Cl₂] = 0.0150 M. Find [NOCl].', answer:0.788, unit:'M', tolerance:0.01,
  ...
  {id:'p71', type:'multi', tag:'Full ICE + verify', q:'For 2HI(g) ⇌ H₂(g) + I₂(g), K = 0.0205. Starting with [HI]₀ = 1.00 M, find [HI] at equilibrium.', answer:0.777, unit:'M', tolerance:0.01,
  ...
  {id:'p73', type:'multi', tag:'Le Châtelier multi', q:'For 2SO₂(g) + O₂(g) ⇌ 2SO₃(g), K = 280 at 1000 K. At equilibrium: [SO₂] = 0.400 M, [O₂] = 0.200 M, [SO₃] = 0.600 M. If [SO₂] is suddenly increased to 0.800 M, in which direction does the reaction shift and by how much does Q change?', answer:2.81, unit:'', tolerance:0.05,
  ...
  {id:'p79', type:'multi', tag:'Haber multi', q:'The Haber process: N₂(g) + 3H₂(g) ⇌ 2NH₃(g). K = 0.500 at 400°C. Starting with [N₂]₀ = 2.00 M and [H₂]₀ = 6.00 M, solve numerically for [NH₃] at equilibrium.', answer:2.39, unit:'M', tolerance:0.05,
    solution:'<p>ICE: N₂ loses x; H₂ loses 3x; NH₃ gains 2x.<br>K = (2x)²/((2.00−x)(6.00−3x)³) = 0.500<br>This does not satisfy a small-x approximation, so solve numerically.<br>At x ≈ 1.194, K ≈ 4x²/((2−x)(6−3x)³) ≈ 0.500.<br>[NH₃] = 2x = 2(1.194) = <strong>2.39 M</strong>.</p>'},
