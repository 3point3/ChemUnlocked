...
export const ALL_PROBLEMS = [
  ...
  {id:'p01',type:'calc',tag:'g → g',
   ...
   solution:'<p>Set up the factor-label chain:</p><p>32.0 g CH₄ × (1 mol CH₄ / 16.04 g) × (1 mol CO₂ / 1 mol CH₄) × (44.01 g CO₂ / 1 mol CO₂) = <strong>87.8 g CO₂</strong>.</p><p>The key middle step is the 1:1 mole ratio from the balanced equation.</p>'},
  ...
  {id:'p02',type:'calc',tag:'g → g',
   ...
   solution:'<p>First convert grams N₂ to moles N₂: 14.0 g N₂ × (1 mol / 28.01 g) = 0.4998 mol N₂.</p><p>Then use the mole ratio and convert to grams: 0.4998 mol N₂ × (2 mol NH₃ / 1 mol N₂) × (17.03 g / mol) = <strong>17.0 g NH₃</strong>.</p>'},
  ...
  {id:'p03',type:'calc',tag:'g → g',
   ...
   solution:'<p>Use factor-label conversion:</p><p>4.00 g H₂ × (1 mol / 2.016 g) × (2 mol H₂O / 2 mol H₂) × (18.02 g / mol) = <strong>35.7 g H₂O</strong>.</p><p>The 2:2 mole ratio simplifies to 1:1.</p>'},
  ...
  {id:'p18',type:'calc',tag:'mol → mol',
   ...
   solution:'<p>Start with the given amount in moles and apply the mole ratio from the balanced equation:</p><p>0.750 mol H₂ × (2 mol NH₃ / 3 mol H₂) = <strong>0.500 mol NH₃</strong>.</p>'},
