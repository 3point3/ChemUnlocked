...
export const ALL_PROBLEMS = [
  ...
  {id:'p02',type:'concept',tag:'Ionic Naming',
   ...
   solution:'<p>K₂O is ionic. K is potassium (always +1). O becomes oxide. Do not use prefixes ("di-") for ionic compounds. No Roman numeral since K has only one charge.</p><p>Name: <strong>potassium oxide</strong>.</p>'},
  ...
  {id:'p06',type:'concept',tag:'Ionic Naming',
   ...
   solution:'<p>Sodium sulfide: Na⁺ and S²⁻. To balance: 2 Na⁺ and 1 S²⁻ → Na₂S. The subscripts come from swapping the charges (cross-multiply method): 1 from Na, 2 from S → <strong>Na₂S</strong>.</p>'},
  ...
  {id:'p08',type:'concept',tag:'Ionic Naming',
   q:'What is the BEST name for the ionic compound formed between barium (Ba²⁺) and oxygen (O²⁻)?',
  ...
  solution:'<p>Oxide is O²⁻, so the negative charge in the compound is −2 total.</p><p>To make the compound neutral, copper must be +2.</p><p>Because copper can have more than one charge, include the Roman numeral: <strong>copper(II) oxide</strong>.</p>'},
  ...
  solution:'<p>Recognize the polyatomic ions first: NH₄⁺ is ammonium and NO₃⁻ is nitrate.</p><p>When a formula uses polyatomic ions, keep their standard names instead of changing the endings.</p><p>So NH₄NO₃ is <strong>ammonium nitrate</strong>.</p>'},
