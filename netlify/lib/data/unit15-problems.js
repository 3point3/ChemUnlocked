...
export const ALL_PROBLEMS = [
  ...
  // ════════════════════════════════════════════════════════════════
  {
    ...
    <p>[H₃O⁺] = 0.010 M</p>
    <p>pH = −log(0.010) = −log(10⁻²) = <strong>2.00</strong></p>`
  },
  {
  ...
  },
  {
    ...
    answer: 2.00, tolerance: 0.05, unit:'',
    solution:`<p>H₂SO₄ is a diprotic strong acid, so each formula unit releases 2 H⁺.</p>
    <p>[H₃O⁺] = 2 × 0.0050 = 0.010 M</p>
  ...
  // ════════════════════════════════════════════════════════════════
  {
    ...
    solution:`<p>Let [H₃O⁺] = x at equilibrium.</p>
    <p>Kₐ = x²/(0.100 − x) ≈ x²/0.100</p>
    <p>x = √(1.8 × 10⁻⁵ × 0.100) = √(1.8 × 10⁻⁶) = 1.34 × 10⁻³ M</p>
    <p>The 5% check works because 1.34% &lt; 5%.</p>
    <p>pH = −log(1.34 × 10⁻³) = <strong>2.87</strong></p>`
  },
  {
    id:'p12', type:'calc', tag:'Weak Acid pH',
    q:'Calculate the pH of a 0.150 M HF solution. Kₐ = 6.8 × 10⁻⁴.',
    answer: 2.01, tolerance: 0.05, unit:'',
    solution:`<p>Set up Kₐ = x²/(C − x) where x = [H₃O⁺] and C = 0.150 M.</p><p>Because Kₐ is relatively large, use the quadratic formula:</p><p>x² + (6.8 × 10⁻⁴)x − (6.8 × 10⁻⁴)(0.150) = 0</p><p>x = [−6.8 × 10⁻⁴ + √((6.8 × 10⁻⁴)² + 4(6.8 × 10⁻⁴)(0.150))] / 2</p><p>x = 9.77 × 10⁻³ M</p><p>pH = −log(9.77 × 10⁻³) = <strong>2.01</strong></p>`
  },
  {
  ...
  },
  {
    ...
    solution:`<p>Conjugate pairs differ by one H⁺:</p><p>Pair 1: HNO₂ (acid) / NO₂⁻ (conjugate base)</p><p>Pair 2: H₃O⁺ (conjugate acid) / H₂O (base)</p><p>Kₐ = 4.5 × 10⁻⁴ &lt; 1, so equilibrium lies to the <strong>left</strong> — HNO₂ is only slightly ionized.</p>`
  },
  {
