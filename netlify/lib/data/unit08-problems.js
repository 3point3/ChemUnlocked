...
export const ALL_PROBLEMS = [
  ...
  {id:'p14', type:'concept', tag:'Acid-Base',
   ...
   correct:1,
   solution:'<p>In a strong acid–strong base neutralization, the spectator ions cancel out.</p><p>The only change is H⁺ + OH⁻ → H₂O, so this net ionic equation is the same no matter which strong acid and strong base are used.</p>'},
