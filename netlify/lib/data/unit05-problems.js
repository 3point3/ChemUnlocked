...
export const ALL_PROBLEMS = [
  ...
  },
  {
    ...
    solution:'<p>For main-group elements, the group number tells you the valence electrons.</p><p>Fluorine is in Group 17, so it has <strong>7 valence electrons</strong>.</p><p>You can confirm it from the configuration 1s² 2s² 2p⁵: the outer level has 2 + 5 = 7 electrons.</p>'
  },
  {
